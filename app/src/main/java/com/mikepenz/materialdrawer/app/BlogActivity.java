    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spjenis = (Spinner) findViewById(R.id.spjenis);
            List<String> item = new ArrayList<String>();
                item.add("Sekolah/Umum");
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(BlogActivity.this,android.R.layout.simple_spinner_dropdown_item,
                item);
        ...
        spmapel = (Spinner) findViewById(R.id.spmapel);
            List<String> item2 = new ArrayList<String>();
                item2.add("Mata Pelajaran");
            ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(BlogActivity.this,android.R.layout.simple_spinner_dropdown_item,
                    item2);
        ...
        spkategori = (Spinner) findViewById(R.id.spkategori);
            ...
            spkategori.setAdapter(adapter3);
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem != null) {
                            ...
                            if (drawerItem.getIdentifier() == 1) {
                                intent = new Intent(BlogActivity.this, PresensiActivity.class);
                            } else if (drawerItem.getIdentifier() == 2) {
                                intent = new Intent(BlogActivity.this, RekapPresensiActivity.class);
                            } else if (drawerItem.getIdentifier() == 3) {
                                intent = new Intent(BlogActivity.this, BlogActivity.class);
                            } else if (drawerItem.getIdentifier() == 4) {
                                intent = new Intent(BlogActivity.this, AktivitasActivity.class);
                            } else if (drawerItem.getIdentifier() == 5) {
                                intent = new Intent(BlogActivity.this, PortalActivity.class);
                            } else if (drawerItem.getIdentifier() == 20) {
                                intent = new LibsBuilder()
                                        .withFields(R.string.class.getFields())
                                        .withActivityStyle(Libs.ActivityStyle.LIGHT_DARK_TOOLBAR)
                                        .intent(BlogActivity.this);
                            }
                            if (intent != null) {
